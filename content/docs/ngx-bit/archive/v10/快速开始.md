...
[![](https://img.shields.io/npm/v/ngx-bit/v10-lts.svg?style=flat-square#align=left&display=inline&height=20&margin=%5Bobject%20Object%5D&originHeight=20&originWidth=138&status=done&style=none&width=138)](https://ngx-bit.kainonly.com/v/10)
...
配置项目环境，修改文件 <u>src\environments\environment.ts</u>
...
建立共享模块（可按照需要来定义），创建文件 <u>src\app\app.ext.module.ts</u>
...
建立公共语言包，创建文件 <u>src\app\app.language.ts</u>
...
编写主服务（需根据后端实际情况更改），修改文件 <u>src\app\common\main.service.ts</u>
...
编写令牌验证服务，修改文件 <u>src\app\common\token.service.ts</u>
...
编写仪表盘组件，修改文件 <u>src\app\dashboards\dashboards.component.ts</u>
...
修改模板文件 <u>src\app\dashboards\dashboards.component.html</u>
...
修改样式文件 <u>src\app\dashboards\dashboards.component.scss</u>
...
编写登录组件，修改文件 <u>src\app\login\login.component.ts</u>
...
建立子语言包，创建文件 <u>src\app\login\language.ts</u>
...
修改模板文件 <u>src\app\login\login.component.html</u>
...
修改样式文件 <u>src\app\login\login.component.scss</u>
...
为登录组件建立懒加载模块，创建文件 <u>src\app\login\login.module.ts</u>
...
为欢迎页组件建立懒加载模块，创建文件 <u>src\app\pages\welcome\welcome.module.ts</u>
...
为空白页组件建立懒加载模块，创建文件 <u>src\app\pages\empty\empty.module.ts</u>
...
建立路由模块（案例中使用的是自定义路由模块），删除默认的 <u>src\app\app-routing.module.ts</u> 并创建 <u>src\app\app.router.module.ts</u>
...
配置项目根模块，修改文件 <u>src\app\app.module.ts</u>
...
修改根组件 <u>src\app\app.component.ts</u>
